<x-guest-layout>
    <section data-section-id="1" data-share="" data-category="confirm-password" data-component-id="fed93509_05_awz" class="relative overflow-hidden">
                ...
                <div class="flex items-center justify-center w-full h-full">
                    <div class="max-w-sm pt-24 pb-20 lg:pt-20 mx-auto">
                        ...
                        <form method="POST" action="{{ route('password.confirm') }}">
                            ...
                            <x-button class="rounded-sm py-3 px-4 bg-purple-500 shadow-md text-white font-medium text-sm w-full hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition duration-200">{{ __('auth.confirm') }}</x-button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                slides: [
                    {
                        ...
                        description: 'Pour votre sécurité, veuillez confirmer votre mot de passe avant de continuer.'
                    },
                    {
                        title: 'Protection de Votre Compte',
                        description: 'Cette étape garantit que seules les personnes autorisées peuvent accéder à votre compte.'
                    },
                    {
                        title: 'Sécurité Avancée',
                        description: 'Nous protégeons vos informations personnelles et vos données sensibles avec les meilleures pratiques.'
                    },
                    {
                        title: 'Accès Sécurisé',
                        description: 'Une fois confirmé, vous pourrez accéder à toutes les fonctionnalités de votre espace.'
                    }
                ],
                startAutoplay() {
