      ...
      <section class="py-12 bg-gray-50">
        <div class="container px-4 mx-auto">
          <h1 class="font-heading text-coolGray-800 text-3xl font-semibold mb-6">Panier</h1>
                ...
                <div class="flex w-full">
                  <div class="w-96">
                    ...
                    <div class="w-full py-4 px-6 border-b border-coolGray-200 h-32 flex items-center">
                      <div class="flex items-center gap-4">
                        <div class="bg-gray-100 rounded-lg w-36 lg:w-24 h-24 flex items-center justify-center">
                          <img src="{{ Vite::asset('resources/coleos-assets/shopping-cart/product1.png') }}" alt="">
                        </div>
                        <div>
                    ...
                    <div class="w-full py-4 px-6 border-b border-coolGray-200 h-32 flex items-center">
                      <div class="flex items-center gap-4">
                        <div class="bg-gray-100 rounded-lg w-36 lg:w-24 h-24 flex items-center justify-center">
                          <img src="{{ Vite::asset('resources/coleos-assets/shopping-cart/product2.png') }}" alt="">
                        </div>
                        <div>
                  ...
                  <div class="w-40">
                    ...
                    <div class="py-4 px-6 border-b border-coolGray-200 h-32 flex items-center">
                      <div class="py-3 px-4 rounded-sm border border-coolGray-200 flex gap-4 items-center bg-white" x-data="{ quantity: 1 }">
                        ...
                        <span x-text="quantity" class="text-rhino-800 text-sm">1</span>
            ...
            <div class="w-full lg:w-1/3 px-4">
              <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="pb-4 border-b border-coolGray-200 flex flex-wrap gap-2 justify-between items-center mb-4">
                  ...
                  <p class="text-rhino-800">$ 357.00</p>
                </div>
                <p class="text-rhino-800 mb-4">Shipping</p>
                <div class="mb-4">
                  <div class="flex items-center justify-between flex-wrap gap-2">
                    <p class="text-rhino-300">Flat Rate</p>
                    <p class="text-rhino-800">$ 20.00</p>
                  </div>
                  <p class="text-rhino-300">Shipping to United States</p>
                </div>
                <div class="pb-4 border-b border-coolGray-200 mb-4"><a class="text-purple-500 hover:text-purple-600 transition duration-200" href="#">Change Shipping Address</a></div>
                <div class="flex items-center justify-between flex-wrap gap-2 mb-4">
                  <h2 class="text-rhino-700 font-semibold text-lg">Order Total</h2>
                  <h2 class="text-rhino-700 font-semibold text-lg">$ 377.00</h2>
                </div>
                <a class="bg-purple-500 py-3 px-4 rounded-sm text-white text-center hover:bg-purple-600 transition duration-200 w-full inline-block" href="#">Passer a l'achat</a>
              </div>
            </div>
          </div>
        </div>
