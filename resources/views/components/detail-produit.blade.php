              ...
              <div class="flex flex-wrap -mx-4">
                <div class="w-full lg:w-1/2 xl:w-3/5 px-4 mb-12 lg:mb-0">
                  <div class="max-w-xl relative">
                    <img class="block w-full h-128 mb-6 lg:mb-0 rounded-xl object-cover" src="/coleos-assets/product-details/product-large.png" alt="">
                      ...
                      <div class="flex flex-wrap -mx-1">
                        <div class="w-1/2 lg:w-1/4 p-1">
                          <button class="block h-28 xl:h-32 w-full lg:p-1.5 bg-white rounded-xl">
                            <img class="block w-full h-full object-cover rounded-xl" src="/coleos-assets/product-details/product-small.png" alt="">
                          </button>
                        </div>
                        <div class="w-1/2 lg:w-1/4 p-1">
                          <button class="block h-28 xl:h-32 w-full lg:p-1.5 bg-white rounded-xl">
                            <img class="block w-full h-full object-cover rounded-xl" src="/coleos-assets/product-details/product-small2.png" alt="">
                          </button>
                        </div>
                        <div class="w-1/2 lg:w-1/4 p-1">
                          <button class="block h-28 xl:h-32 w-full lg:p-1.5 bg-white rounded-xl">
                            <img class="block w-full h-full object-cover rounded-xl" src="/coleos-assets/product-details/product-small3.png" alt="">
                          </button>
                        </div>
                        <div class="w-1/2 lg:w-1/4 p-1">
                          <button class="block h-28 xl:h-32 w-full lg:p-1.5 bg-white rounded-xl">
                            <img class="block w-full h-full object-cover rounded-xl" src="/coleos-assets/product-details/product-small4.png" alt="">
                          </button>
                        </div>
                      </div>
                    </div>
